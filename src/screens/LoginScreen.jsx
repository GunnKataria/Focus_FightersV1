...
export default function LoginScreen() {
  ...
  const handleGoogle = async () => {
    ...
    // Loading stays true — page will redirect via onAuthStateChange
  };
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <Card glow>
          ...
          >
            {/* Google "G" SVG */}
            {loading ? (
              <span style={{ fontSize: "1.2rem", animation: "boss-idle 1s ease-in-out infinite" }}>⚔️</span>
            ) : (
          ...
          <p style={{ textAlign: "center", color: "var(--text-muted)", fontSize: ".8rem", fontFamily: "var(--font-heading)", letterSpacing: ".05em", marginTop: "1rem", lineHeight: 1.6 }}>
            Sign in to save your progress,<br />earn XP, and compete with your squad.
          </p>
        </Card>
      </div>
    </div>
